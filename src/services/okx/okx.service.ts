...
export class OkxService {
    ...
    public async tokenDetailCall<T>(ticker: string): Promise<TokenDetail>{
    ...
    public async priceTokenData<T>(incriptionId: string): Promise<SummaryToken>{
